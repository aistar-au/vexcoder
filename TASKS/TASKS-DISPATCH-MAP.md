...
## Remaining Work Summary (25 items across 4 active tiers)

Tiers 1–5 are complete; 25 items remain across Tiers 6–9.
...
| 6 | ADR-021 P2 | 11 | Open | Code quality and duplication removal |
...
Tiers 1–5 are complete.  The current batch is Tier 6 code quality (ADR-021
P2): duplication removal, race condition fixes, and design follow-ups.
Items 15 and 22 are done; 11 items remain.  See `TASKS/ACTIVE-ROADMAP.md`
for the full 25-item, 4-active-tier breakdown.
