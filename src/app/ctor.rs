...
impl TuiMode {
    ...
    pub fn new_with_config(notes_path: Option<PathBuf>, config: Config) -> Self {
        ...
        Self {
            ...
            delta_accumulators: std::collections::HashMap::new(),
            pending_quit: false,
            ...
            current_turn_stream_segments: Vec::new(),
            active_stream_segment_index: None,
            structured_streaming_active: false,
            ...
            last_pending_tool_name: None,
            duplicate_tool_count: 1,
            same_name_tool_count: 0,
            ...
            ttft: None,
            last_turn_ttft: None,
            current_turn_prompt_progress: None,
            current_turn_timings: None,
            last_turn_timings: None,
