...
- Accepted/deprecated ADR records: `adr/completed/ADR-XXX-*.md`
...
| **Amended** | Existing ADR amended without deprecating the base decision |
...
| [ADR-031](ADR-031-operator-surface-ui-overhaul.md) | Operator surface UI overhaul | Accepted (all batches A-E merged; 2026-04-08 host-scrollback amendment deprecated 2026-04-09) | Current operator surface keeps one owned transcript; no host-scrollback cutover is pending |
...
| [ADR-047 amendment (2026-04-16)](ADR-047-amendment-2026-04-16.md) | API-first runtime event envelope and trait reduction | Amended | Phase A targets `json_handoff.rs` envelope metadata and explicit tool lifecycle events before retiring legacy runtime loop traits |
| [ADR-047 amendment (2026-04-20)](ADR-047-amendment-2026-04-20.md) | RuntimeEnvelope API normalization and consumer boundary | Amended | PRs #402-404 closed server/client normalization and direct-envelope consumer migration; current follow-up is runtime-handoff extraction, local/private-network full-response fallback, and resumable replay |
