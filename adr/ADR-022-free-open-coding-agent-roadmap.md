...
**Amendment:** 2026-03-03 — Decision item 1 and the final Compliance note scoped to the first release; Decision item 11 added to reserve native packaging and editor surfaces for later-stage ADRs. See ADR-024 §Gap 9 for the binary distribution and macOS packaging decision.
...
4. The first release is interactive and resumable.
...
Task state is durable on disk. The first release supports exactly one active
