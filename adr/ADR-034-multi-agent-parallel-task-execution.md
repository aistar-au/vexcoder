...
the initial delivery. That deferral covered four distinct concerns that are now
...
post-launch orchestration lane that extends the existing runtime rather than
...
- ADR-024's multi-agent deferral becomes a defined post-launch lane instead
