...
| [ADR-024](ADR-024-zero-licensing-cost-agent-parity-gaps.md) | Zero-licensing-cost agent parity gaps | Proposed (pre-launch complete) | 1 external item in the next batch: PG-03 tap auto-dispatch after the tap repo exists |
