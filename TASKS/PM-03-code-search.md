...
**Target Files:** `src/tools/index.rs`, `src/tools/search.rs`,
`src/tools/semantic.rs`, `src/state/conversation/tools.rs`,
`src/tools/operator.rs`, `src/app/commands.rs`, `src/config.rs`,
`src/config/load.rs`
