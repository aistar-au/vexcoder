...
| ADR-026 | Proposed | Follows ADR-025 closeout and ADR-024 reconciliation (`PI-13` through `PI-16`); `PI-13` through `PI-15` are implemented in the current tree, and `PI-16` is the next dependency-sequenced validation batch. |
