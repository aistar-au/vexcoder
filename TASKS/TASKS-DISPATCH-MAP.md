...
## Remaining Work Summary (7 items — Tier 8 post-milestone, deferred)

Tiers 1–7 and Tier 9 are complete. Only Tier 8 items remain and they are explicitly deferred until after milestone-1.
...
| 8 | ADR-024 G/H + ADR-022 | 7 | Open (deferred) | Post-milestone release pipeline and packaging |
...
Tiers 1–7 and Tier 9 are complete. The only remaining work is Tier 8
(ADR-024 G/H + ADR-022 Decision 11): 7 post-milestone items for release
pipeline, packaging, and macOS app layer — all explicitly deferred until
after milestone-1. See `TASKS/ACTIVE-ROADMAP.md` for the breakdown.
