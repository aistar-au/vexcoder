...
| :--- | :--- | :--- | :--- | :--- |
| Ratatui-C1 | `work/vexcoder-ratatui-crossterm-compliance-plan` | pending | **In Progress** | ECMA-48 / ratatui / crossterm compliance lane for inline viewport, bracketed paste, scroll-region, resize, and Windows VT capability contracts; preserve the current primary-screen scrollback lifecycle unless a later ADR changes it |
