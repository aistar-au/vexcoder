...
For Rust edits, keep diffs rustfmt-consistent and avoid formatting-only churn: preserve surrounding style, make the smallest semantic change that solves the task, and do not hand-wrap argument lists or method chains against local conventions.\n\
