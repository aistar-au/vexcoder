...
pub use task_state::{
    ...
    InterruptedCommand, JoinIndex, LiveJoinEntry, PathChange, RecordedDecision, SessionNote,
    StateEnvelope, StateRefs, TaskId, TaskState, TaskStatus, WorkingSetRecord,
};
