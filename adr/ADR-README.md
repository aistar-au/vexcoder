...
| [ADR-043](ADR-043-structured-output-parser-adoption-gates.md) | Structured output parser adoption gates | Proposed | 3 adoption gates: live runtime wiring, parity coverage, defect reduction |
